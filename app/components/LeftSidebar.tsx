...
export default function LeftSidebar() {
  ...
  // Don't show on mobile when scrolling down
  ...
  if (windowWidth < 768 && !isVisible && windowWidth > 0) return null;
      ...
      <nav className="flex flex-col gap-4 items-center">
        ...
        <div className="flex flex-col gap-3 mb-4">
          <a
            ...
            className="w-12 h-12 rounded-xl bg-[#1A1A22] border border-[#2f2a37] flex items-center justify-center hover:border-[#6D28D9] hover:bg-[#6d28d915] hover:scale-110 transition-all group relative"
            aria-label="GitHub"
          >
            ...
            <svg className="w-5 h-5 text-[#9CA3AF] group-hover:text-[#6D28D9] transition-colors" fill="currentColor" viewBox="0 0 24 24">
